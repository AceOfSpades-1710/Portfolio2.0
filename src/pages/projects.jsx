...
import WebdevImg from '../assets/Fore_Hero/Webdev.png'
import MLImg from '../assets/Fore_Hero/ML.jpg'
import GDImg from '../assets/Fore_Hero/GD.jpg'
...
export default function Projects() {
  ...
  function animateTo(i, duration = 0.8) {
  ...
  /* initial positioning */
  useLayoutEffect(() => {
    gsap.set(trackRef.current, { x: -index * vw() })
  }, [])
