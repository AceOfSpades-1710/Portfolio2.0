...
const SERVICES = [
  {
    ...
    content: (
      <>
        <p><span>●</span> Generate structured reports using AI-powered data extraction.</p>
        <p><span>●</span> Build scalable, responsive, production-ready web apps.</p>
        <p><span>●</span> Optimize performance and accessibility across devices.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p><span>●</span> Design and deploy intelligent ML pipelines.</p>
        <p><span>●</span> Data preprocessing, training, and evaluation.</p>
        <p><span>●</span> Model optimization and real-world integration.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p><span>●</span> Brand-focused visual systems.</p>
        <p><span>●</span> UI assets and marketing creatives.</p>
        <p><span>●</span> High-impact digital illustrations.</p>
      </>
    ),
  },
]
...
export default function Services() {
  ...
  const handleCardClick = index => {
    ...
    tl.to(clickedCard, { x: targetX, duration: 0.5 }, "<")
      ...
      <section id="services" className="parent-services">
        {SERVICES.map((service, i) => (
          ...
          >
            ...
            {/* ✅ MOBILE CONTENT UNDER CARD */}
            {isMobile && activeIndex === i && (
              <div className="content-panel-wrapper mobile">
                <ContentPanel content={service.content} />
              </div>
            )}
          </div>
        ))}
